...
from datasets import chest_xray
...
LOGS_PATH = os.path.join(ROOT_PATH, 'log', 'unet_chest_xray')
...
NUM_CLASSES = chest_xray.NUM_CLASSES
...
transform = transforms.Compose([transforms.Resize((256, 256)), transforms.ToTensor(),
                                transforms.Normalize(mean=chest_xray.MEAN,
                                                     std=chest_xray.STD)])
target_transform = transforms.Compose([transforms.Resize((256, 256)), transforms.ToTensor()])

train_data = chest_xray.ChestXray(mode='train', transform=transform, target_transform=target_transform)
val_data = chest_xray.ChestXray(mode='val', transform=transform, target_transform=target_transform)
